...
CONFIG_FILE = "/content/drive/MyDrive/object_detection/model_config.yaml"
MODEL_FILE = "/content/drive/MyDrive/object_detection/output/model_final.pth"
...
def main():
    ...
    st.image(Image.open("/content/drive/MyDrive/object_detection/images/example-amenity-detection.png"), 
